          ...
          <div class="col s12 m6">
              <div class="card amber lighten-3 content-border-default">
                <div class="card-content black-text form-login-data">
                    <span class="card-title" style="color: #000 !important;">Listagem de Fornecedores</span>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><a href="editarFornecedor.php?id=<?php echo $dados['id'];?>" class="btn-floating orange"><i class="material-icons">edit</i></a></td>
                        ...
                        <!-- Modal delete -->
                          <div id="modal<?php echo $dados['id'];?>" class="modal">
                            <div class="modal-content">
                              <h3>Atenção!</h3>
                              <p>Deseja excluir esse fornecedor?</p>
                            </div>
                ...
                <div class="card-action">
                    ...
                    <a href="cadastroFornecedor.php" class="btn green"> Adicionar Fornecedor </a>
                </div>
              </div>
            </div>
        <div>
